...
<div class="container" style="max-width: 1200px;">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<ul style="list-style-type:disc">
						<li>
							<p>The “EMSI COURS” Website (web based application) is useful for the
	...
	<div class="row">
		<div class="col-lg-12">
			<h2 class="page-header">EMSI COURS</h2>
		</div>
		<div class="col-md-6">
			<p>The EMSI COURS by <strong>student of emsi</strong> includes:</p>
			<ul>
