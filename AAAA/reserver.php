			...
			<fieldset>
				...
				<form action="" method="POST" name="update">
					...
					<div class="col-md-12">
						...
						<br>
						<div>
							<h4> <strong>Q1. What date would you like to pick up the material?</strong></h4>
							<div><textarea name="Q1" rows="5" cols="150" required placeholder="la forme de la date : DD/MM/YYYY"></textarea></div>
						</div>
						<br>
						<div>
							<h4> <strong>Q2. How long do you plan to use it for?</strong></h4>
							<div><textarea name="Q2" rows="5" cols="150" required placeholder="par exemple 10 jours "></textarea></div>
						</div>
						<br>
						<div>
							<h4> <strong>Q3. Do you have a preferred return date? </strong></h4>
							<div><textarea name="Q3" rows="5" cols="150" required placeholder="la forme de la date : DD/MM/YYYY"></textarea></div>
						</div>
						<br>
						<div>
							<h4> <strong>Q4. Will you be picking up the material yourself or would you like it delivered?</strong></h4>
